...
if st.button("➕ Añadir Registro"):
    try:
        ...
        df_registros = pd.DataFrame(columns=["fecha", "km_inicial", "km_final", "galones", "precio", "es_repostaje", "aire_acondicionado", "km_recorridos", "consumo_km_gal", "costo_por_km"])
    ...
    if km_final > km_inicial:
        ...
        if es_repostaje and galones > 0 and precio > 0:
            ...
            consumo_km_gal = np.nan  # Usamos NaN para indicar que no hay datos de combustible para este registro
            costo_por_km = np.nan
